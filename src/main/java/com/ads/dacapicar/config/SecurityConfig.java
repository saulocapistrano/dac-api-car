    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        if (Arrays.asList(environment.getActiveProfiles()).contains("homolog")) {
            http.headers().frameOptions().disable();
                ...
                .antMatchers(HttpMethod.GET,"/api/report/pdf/").hasAuthority("PRIVILEGE")
                .antMatchers(HttpMethod.GET, "/api/report/report/{id}").authenticated()
                ...
                .antMatchers(HttpMethod.DELETE, "/api/users/").hasAuthority("PRIVILEGE")
                        ...
                        .antMatchers(HttpMethod.GET, "/api/qrcode/user/").authenticated()
